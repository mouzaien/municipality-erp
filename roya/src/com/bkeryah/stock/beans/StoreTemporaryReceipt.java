...
public class StoreTemporaryReceipt {
	...
	public String accept() {
		System.out.println("accept Step");
		wrkAppComment = "";
	...
	public String save() {
		try {
			for (StoreTemporeryReceiptDetailsModel item : temporeryReceiptDetailsModelList) {
				...
				System.out.println(
						"item = " + temporeryReceiptDetails.getQty() + " - " + temporeryReceiptDetails.getArticleId());
				temporeryReceiptDetails = new StoreTemporeryReceiptDetails();
			}
			System.out.println("ListSize = " + temporeryReceiptDetailsList.size());
			masterData();
