...
public enum MailTypeEnum {
	COPY(0),KITAB(143),MODAKARA(242), MAILS(1), AUTORIZATION(230), SPECIAL_AUTORIZATION(245), WORKMISSION(153), LEAVE(3), LEAVESUCCESSOR(144), TRAINING(
			235), RESIGNATION(6),
PROJECTeXTRACT(236)	,EARLYRETIREMENT(7),EXCHANGEREQUEST(237), SALARY(232), SALAR(233), MEDICALEXAMINATION(9), ERROR(-1), VACATION(25), VACNEEDED(26), SICK_VACATION(28), TRANSACTION(114), LIC(118),MEDICALREPORT(234),
HEALTH_LICENCE(117),ACTUALEXCHANGE(238), PROCUREMENT_MATERIALS(239),PERSONAL_COMMENT(240),FINE_REBOUND(241),MEMO_RECEIPT(197), NEW_BUILDING_LICENCE(119), ATTACH_BUILDING_LICENCE(243),NEW_BUILDING_WALL_LICENCE(244), COMPACT_PERFORMANCE(246),GENERAL_APPRECIATION(248),PERFORMANCE_EVALUATION(247); 
	private int value;
