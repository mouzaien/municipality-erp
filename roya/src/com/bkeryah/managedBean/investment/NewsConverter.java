...
public class NewsConverter implements Converter {
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		InvNewspaper clause = null;
		if (value != null && value.trim().length() > 0) {
			try {
				clause = (InvNewspaper) dataAccessService.findEntityById(InvNewspaper.class, Integer.parseInt(value));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public String getAsString(FacesContext fc, UIComponent uic, Object object) {
		String val = null;
		if (object != null) {
			val = String.valueOf(((InvNewspaper) object).getCode());
		}
		return val;
	}
