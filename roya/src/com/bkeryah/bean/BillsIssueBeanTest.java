...
@ManagedBean
@ViewScoped
public class BillsIssueBeanTest {
	...
	public Double digline ;
	public Integer daysNumber;
	public Integer extendsNumber;
	public List<PayBillDetails> streetDigResult;
	/******************** ATM **********************/
	...
	List<BillIssueDetail> selectBillIssue = new ArrayList<>();
	List<TradIssueType> selectTradeType = new ArrayList<>();
	Integer tradType ;
	public Integer streetGeneral;
	public Integer streetType;
	public List<BillIssueDig> selectStreetDigType = new ArrayList<>();
	public List<BillIssueDigDetail> listStreetDigDetail = new ArrayList<>();
	

	@PostConstruct
	public void init() {
		selectTradeType = dataAccessService.loadTrdType();
		selectBillIssue = dataAccessService.loadBillIssue();
		selectStreetDigType = dataAccessService.loadStreetDig();
	}
...
Double rubish = 0.0;
		tradeMarketResult = dataAccessService.calctradingMarket(getTradType(),getTradeMarketMainActivity(),tradeMarketAdvArea
	...
	Double rubish = 0.0;
		petrolStationResult = dataAccessService.calculatePetrolStationFees(petrolStationIssueType, petrolStationAdvArea,
...
//				petrolStationAddAdvArea, petrolStationIssueYears, petrolStationArea, false);
//	}
	public void calculateStreetLine(ActionEvent ae) {
//	Double rubish = 0.0;
		streetDigResult = dataAccessService.calculateStreetDig(getDigline(), getDaysNumber() , getStreetType(),getExtendsNumber(),isExtend );
...
//			}
	...
	public void openBillDlg9(ActionEvent ae) {
		newBill.setBillOwnerName("");
		RequestContext context = RequestContext.getCurrentInstance();
		selectedDetailList = streetDigResult;
		if (selectedDetailList.size() > 0) {
			context.execute("PF('AddBillDlgVar').show();");
		} else {
			MsgEntry.addErrorMessage("ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø£ÙˆÙ„Ø§");
	...
	public List<BillIssueDetail> getSelectBillIssue() {
		return selectBillIssue;
	}

	public void setSelectBillIssue(List<BillIssueDetail> selectBillIssue) {
		this.selectBillIssue = selectBillIssue;
	}

	public List<TradIssueType> getSelectTradeType() {
		return selectTradeType;
	}

	public void setSelectTradeType(List<TradIssueType> selectTradeType) {
	...
	public void loadDigDetail(){
		listStreetDigDetail = dataAccessService.getTypeDigByCat(streetGeneral);
	}

	public Integer getStreetGeneral() {
		return streetGeneral;
	}

	public void setStreetGeneral(Integer streetGeneral) {
		this.streetGeneral = streetGeneral;
	}
	...
	public List<BillIssueDig> getSelectStreetDigType() {
		return selectStreetDigType;
	}

	public void setSelectStreetDigType(List<BillIssueDig> selectStreetDigType) {
		this.selectStreetDigType = selectStreetDigType;
	}

	public List<BillIssueDigDetail> getListStreetDigDetail() {
		return listStreetDigDetail;
	}

	public void setListStreetDigDetail(List<BillIssueDigDetail> listStreetDigDetail) {
		this.listStreetDigDetail = listStreetDigDetail;
	}

	public Double getDigline() {
		return digline;
	}

	public void setDigline(Double digline) {
		this.digline = digline;
	}
	...
	public Integer getExtendsNumber() {
		return extendsNumber;
	}

	public void setExtendsNumber(Integer extendsNumber) {
		this.extendsNumber = extendsNumber;
	}

	public List<PayBillDetails> getStreetDigResult() {
		return streetDigResult;
	}

	public void setStreetDigResult(List<PayBillDetails> streetDigResult) {
		this.streetDigResult = streetDigResult;
	}
