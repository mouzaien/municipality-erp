...
public class BeansManager {
	...
	static{
		String path = FacesContext.getCurrentInstance().getExternalContext().getRealPath("/WEB-INF/applicationContext.xml");
		context = new FileSystemXmlApplicationContext(path);
	}
	 
	
//	final static  ApplicationContext   context =  			new FileSystemXmlApplicationContext
